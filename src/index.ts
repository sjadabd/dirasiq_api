...
import superAdminAccountDeletionRoutes from './routes/super_admin/account-deletion.routes';
import superAdminAdvertisementRoutes from './routes/super_admin/advertisement.routes';
...
app.use('/api/super-admin/account-deletion-requests', superAdminAccountDeletionRoutes);
app.use('/api/super-admin/advertisements', superAdminAdvertisementRoutes);
