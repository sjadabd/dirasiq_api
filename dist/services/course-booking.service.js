...
class CourseBookingService {
    ...
    static async getStudentBookings(studentId, studyYear, page = 1, limit = 10, status) {
        try {
            return await course_booking_model_1.CourseBookingModel.findAllByStudent(studentId, studyYear, page, limit, status);
        }
        catch (error) {
            throw error;
        }
    ...
    static async reactivateBooking(id, studentId) {
        try {
            return await course_booking_model_1.CourseBookingModel.reactivateBooking(id, studentId);
        }
        catch (error) {
            throw error;
        }
